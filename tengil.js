...
document.querySelector(".tombol").addEventListener('click', function () {
  ...
  Swal.fire("Hallo Sayangkuu", "Aku ada pertanyaan nih buat kamu?", "question").then(function () {
...
const {
          ...
          inputValidator: (value) => {
            ...
            if (!value) {
              ...
              return 'Isi dulu sayanggku cintaku'
          ...
          const pertanyaan = Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              Swal.fire(`Yakin gasayang sama ${sender}?`, '', 'error').then(function () {
